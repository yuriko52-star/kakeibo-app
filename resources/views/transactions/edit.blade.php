<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center mb-1">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">取引を編集</h2>
    ...
    <div class="py-8 max-w-2xl mx-auto px-4">
        ...
        <form action="{{ route('transactions.update',$transaction) }}" method="POST" novalidate class="bg-white shadow rounded p-6">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="spent_at" value="{{ old('spent_at', $transaction->spent_at) }}" class="w-full border rounded px-3 py-2">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="memo" value="{{ old('memo', $transaction->memo) }}" class="w-full border rounded px-3 py-2">
